 ...
 * @author usu
 */
public class MySQLAdmin implements Serializable {
     ...
     * @param password
     */
    public MySQLAdmin(char[] username, char[] password) {
     ...
     * @param encript 
     */
    public MySQLAdmin(char[] username, char[] password, String encript) {
        setEncript(encript);
    ...
    public boolean equals(Object obj) {
        ...
        final MySQLAdmin other = (MySQLAdmin) obj;
        ...
        if (this.encript != other.encript && (this.encript == null || !this.encript.equals(other.encript))) {
            return false;
        }
        return true;
    }
    ...
    public int hashCode() {
        ...
        hash = 23 * hash + (this.encript != null ? this.encript.hashCode() : 0);
        return hash;
    }
}
